...
<head>
    ...
    <!-- toastr通知插件css -->
    <link href="${pageContext.request.contextPath}/admin/H+/css/plugins/toastr/toastr.min.css" rel="stylesheet">
    ...
    <script src="${pageContext.request.contextPath}/admin/H+/js/contabs.js"></script>
